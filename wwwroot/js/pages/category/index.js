...
var tableCategoryIndex;

function initTableCategoryIndex() {

    if (tableCategoryIndex != undefined) {
        tableCategoryIndex.destroy();
    }

    tableCategoryIndex = $('#tableCategory').DataTable(
        {
            ajax: {
                url: "/Category/GetAll",
                type: "POST",
...
$(document).on('click', '.action-delete', function () {
    ...
    Swal.fire({
        ...
        if (result.value) {
            runQuery('/Category/Delete', fileData, "#demo", function (result) {
...
$(document).on('click', '.action-get', function () {
    ...
    $(".modal-xlarge").load('/Category/Information?modal=modal-xlarge&reload=true&id=' + id, function () {
...
$(document).on("click", ".action-create", function () {
    ...
    $(".modal-xlarge").load('/Category/Information?modal=modal-xlarge&reload=true', function () {
        var myModal = new bootstrap.Modal(document.getElementById('modal-xlarge'), {
            keyboard: false,
            backdrop: 'static'
        })
